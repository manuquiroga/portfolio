...
export default function About() {
  const imageUrl =
    "https://i.ibb.co/S6SxZr9/20240201-151741-magicstudio-oulrm159e5e.png";
      ...
      <div className="flex justify-center items-center gap-16 flex-col sm:flex-row">
        <div className="w-[250px] h-[250px] rounded-full object-cover">
          <img
            src={imageUrl}
            alt="Profile image"
            className="w-full h-full object-cover max-w-full rounded-full "
        ...
        <div className="flex flex-col gap-3 w-[23rem] sm:w-[35rem]">
          <p className="text-white text-lg font-medium ">
            I was born in Argentina on June 10, 2002, and I
            graduated as a technical programmer from the
            National Technological University (UTN) in 2023.
          </p>
          {/* <p className="text-white text-lg font-medium">
          ...
          <p className="text-white text-lg font-medium">
            ...
            playing the guitar, and going to the gym.
          </p>
        </div>
      </div>
    </motion.section>
